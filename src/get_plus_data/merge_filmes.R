...
dataset_dir <- Sys.getenv("FILM_DATASET_DIR_ES") # pega a variavel de ambiente do dir de trabalho 
...
dados_filmes_registrados <- dados_filmes_registrados %>% 
  select(
    -DATA_EMISSAO_ROE,
    -SITUACAO_OBRA,
    -REQUERENTE,
